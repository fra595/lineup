// Shared lists used by sign-up, discovery, and gig-posting screens.
// Keeping these in one file means every screen stays in sync.

export const ROLES = ["Musician", "Music Director", "Sound Engineer", "MC / Host"];
